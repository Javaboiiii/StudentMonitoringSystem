...
public class forgotPassword {
    ...
    private void sendEmail(String recipientEmail, int otp) {
        ...
        String host = "smtp.gmail.com"; // For Gmail SMTP
        String senderEmail = "manasi.mhatre23@vit.edu"; // Replace with your sender's email
        String senderPassword = System.getenv("EMAIL_PASSWORD"); // Fetch password from environment variable
